...
vector_search_index = os.getenv(
    "VECTOR_SEARCH_INDEX", "my-rag-agent-from-gcs-vector-search"
)
vector_search_index_endpoint = os.getenv(
    "VECTOR_SEARCH_INDEX_ENDPOINT", "my-rag-agent-from-gcs-vector-search-endpoint"
)
vector_search_bucket = os.getenv(
    "VECTOR_SEARCH_BUCKET", f"{project_id}-my-rag-agent-from-gcs-vs"
)
